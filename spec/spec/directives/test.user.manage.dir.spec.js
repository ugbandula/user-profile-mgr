...
describe('Unit testing great quotes', function() {
    ...
    it('\tTest condition #' + apiUtils.getGlobalTestConditionNo() + ' [ Scenario No: ' + getNextTestConditionNo() + ']: Manage user template testing', function () {
    // it('Replaces the element with the appropriate content', function() {
        /**
         * Compiles a piece of HTML containing the directive
         */
        var element = $compile("<manage-user></manage-user>")($rootScope);
        /**
         ...
         */
        expect(element.html()).toContain("Manage User Profile");
    });
});
